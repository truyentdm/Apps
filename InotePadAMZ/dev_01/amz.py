...
labelLen = StringVar()
lblmessage = Label(window,textvariable=labelLen).grid(row=4,column=0)
labelMessage = StringVar()
lblmessage = Label(window,textvariable=labelMessage).grid(row=4,column=1)
